(function () {
  ...
  Ajax = {
    getURL: function (object) {
      return (
        (typeof object.url === "function" ? object.url() : void 0) || object.url
      );
    },
    ...
    getScope: function (object) {
      return (
        (typeof object.scope === "function" ? object.scope() : void 0) ||
        object.scope
      );
    },
  ...
  Base = (function () {
    ...
    Base.prototype.ajaxQueue = function (params, defaults, record) {
      ...
      promise.abort = function (statusText) {
        ...
        deferred.rejectWith(settings.context || settings, [
          promise,
          statusText,
          "",
        ]);
  ...
  Singleton = (function (_super) {
    ...
    Singleton.prototype.recordResponse = function (options) {
      ...
      return function (data, status, xhr) {
        ...
        return (_ref1 = options.done) != null
          ? _ref1.apply(_this.record)
          : void 0;
      };
    };
    Singleton.prototype.failResponse = function (options) {
      ...
      return function (xhr, statusText, error) {
        ...
        return (_ref1 = options.fail) != null
          ? _ref1.apply(_this.record)
          : void 0;
      };
    };
